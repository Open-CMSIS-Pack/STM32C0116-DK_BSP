/******************************************************************************
 * @file     vio_STM32C0116-DK.c
 * @brief    Virtual I/O implementation for board STM32C0116-DK
 * @version  V1.0.0
...
/*! \page vio_STM32C0116-DK Physical I/O Mapping

The table below lists the physical I/O mapping of this CMSIS-Driver VIO implementation.

| Virtual I/O   | Variable       | Board component      | Pin
|:--------------|:---------------|:---------------------|:------
| vioLED0       | vioSignalOut.0 | LED green       (LD3)| PB6
*/
...
//  signal,     pin,                   pull resistor,      active state
  { vioLED0,    GPIO_PIN_ID_PORTB(6),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_LOW }
};
#endif
